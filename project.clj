(defproject bing-webmaster-bulk-url-removal "0.1.0-SNAPSHOT"
                          ...
                          {:background
                           {:source-paths ["src/background"]
                            ...
                            :compiler     {:output-to     "resources/unpacked/compiled/background/main.js"
                                           ...
                                           :main          bing-webmaster-bulk-url-removal.background
                                           :optimizations :none
                                           :source-map    true}}
                           :popup
                           {:source-paths ["src/popup"]
                            ...
                            :compiler     {:output-to     "resources/unpacked/compiled/popup/main.js"
                                           ...
                                           :preloads      [devtools.preload figwheel.preload]
                                           :main          bing-webmaster-bulk-url-removal.popup
                                           :optimizations :none
                                           :source-map    true}}}}}
                          ...
                          {:content-script
                           {:source-paths ["src/content_script"]
                            :compiler     {:output-to     "resources/unpacked/compiled/content-script/main.js"
                                           ...
                                           :main          bing-webmaster-bulk-url-removal.content-script
